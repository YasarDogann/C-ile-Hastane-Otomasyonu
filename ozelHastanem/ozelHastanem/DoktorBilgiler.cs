...
namespace ozelHastanem
{
    public partial class DoktorBilgiler : Form
    {
        ...
        private void listele()
        {
            ...
            tablo.Clear();
            OleDbDataAdapter adapter = new OleDbDataAdapter("select * from doktor", baglan);
            adapter.Fill(tablo);   
        ...
        private void button2Ekle_Click(object sender, EventArgs e)
        {
            ...
            {
                OleDbConnection baglan = new OleDbConnection("Provider=Microsoft.Ace.OleDb.12.0;Data Source = " + Application.StartupPath + "\\kullanici.accdb");
                OleDbCommand kmt = new OleDbCommand("INSERT INTO doktor(tc,adi,soyadi,telefon,adres,yetki,brans,sifre) Values ('" + textBox1.Text + "','" + textBox2.Text + "'," +
        ...
        private void button3Sil_Click(object sender, EventArgs e)
        {
            ...
            {
                OleDbConnection baglan = new OleDbConnection("Provider=Microsoft.Ace.OleDb.12.0;Data Source = " + Application.StartupPath + "\\kullanici.accdb");
                OleDbCommand kmt = new OleDbCommand("DELETE FROM doktor Where tc='" + dataGridView1.CurrentRow.Cells[0].Value.ToString()+"'",baglan);
        ...
        private void button6Kaydet_Click(object sender, EventArgs e)
        {
            ...
            {
                OleDbConnection baglan = new OleDbConnection("Provider=Microsoft.Ace.OleDb.12.0;Data Source = " + Application.StartupPath + "\\kullanici.accdb");
                OleDbCommand kmt = new OleDbCommand("UPDATE doktor SET tc='" + textBox1.Text + "',adi='" + textBox2.Text + "',soyadi='" + textBox3.Text + "',telefon='" + textBox4.Text + "'," +
        ...
        private void textBox9_TextChanged_1(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                DataTable tablo = new DataTable();
                tablo.Clear();
                OleDbDataAdapter adapter = new OleDbDataAdapter("SELECT * FROM doktor where tc like '%" + textBox9.Text + "%'", baglan);
                adapter.Fill(tablo);
                dataGridView1.DataSource = tablo;
            }
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            string csvFilePath = "Doktor-Başhekim-Bilgileri.csv";
